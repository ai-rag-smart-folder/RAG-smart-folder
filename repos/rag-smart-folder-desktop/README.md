...
- **Backend API** running on http://localhost:8003
  - See [rag-smart-folder-backend](https://github.com/yourusername/rag-smart-folder-backend)
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/yourusername/rag-smart-folder-desktop.git
   cd rag-smart-folder-desktop
   ```
